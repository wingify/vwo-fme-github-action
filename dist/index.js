...
const EvaluateFlag_1 = require("./actions/EvaluateFlag");
/**
    ...
    try {
        ...
        */
        ...
        if (flagsWithVariables) {
            yield (0, EvaluateFlag_1.evaluate)(flagsWithVariables);
        }
    }
    catch (error) {
        core.setFailed(`Error occurred while running the action: ${error instanceof Error ? error.message : String(error)}`);
    }
});
run();
